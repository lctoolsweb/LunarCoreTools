            ...
            <div class="relative items-center hidden ml-auto lg:flex">
              <nav class="text-sm font-semibold leading-6 text-slate-700 dark:text-slate-200">
                <ul class="flex space-x-8">
                  <li>
                    <a href="https://www.morax.top/" target="_bank" class="block ml-6 text-slate-400 hover:text-slate-500 dark:hover:text-slate-300">
              ...
              <div class="flex items-center pl-6 ml-6 border-l border-slate-200 dark:border-slate-800">
                <a-tooltip :content="theme === 'light' ? '设置暗黑主题' : '设置明亮主题'">
                  <a-button size="mini" class="nav-btn" type="outline" :shape="'circle'" @click="toggleTheme.toggle">
                    <template #icon>
                ...
                <a href="https://github.com/lctoolsweb/LunarCoreTools" target="_bank" class="block ml-6 text-slate-400 hover:text-slate-500 dark:hover:text-slate-300">
